  ...
  return (
    <div className="container mt-5 p-5">
      <div className="row text-muted">
        <h2>
          <b>Charges explained</b>
        </h2>

        {/* First half column */}
        <div className="col-6 mt-4" style={{ lineHeight: "35px" }}>
          <h4 className="mb-4">Securities/Commodities transaction tax</h4>
          <p>
          ...
          <h4 className="mb-4">Transaction/Turnover Charges</h4>
          <p>
          ...
          <h4 className="mb-4">Call & trade</h4>
          <p>
            Additional charges of ₹50 per order for orders placed through a
            dealer at Zerodha including auto square off orders.
          </p>
          <h4 className="mb-4">Stamp charges</h4>
          <p>
          ...
          <h4 className="mb-4">NRI brokerage charges</h4>
          <p>
            <ul>
              <li>
          ...
          <h4 className="mb-4">Account with debit balance</h4>
          <p>
          ...
          <h4 className="mb-4">Margin Trading Facility (MTF)</h4>
          <p>
            <ul>
              <li>
        ...
        {/* Second half column */}
        <div className="col-6 mt-4" style={{ lineHeight: "35px" }}>
          <h4 className="mb-4">GST</h4>
          <p>
            Tax levied by the government on the services rendered. 18% of (
            brokerage + SEBI charges + transaction charges)
          </p>
          <h4 className="mb-4">SEBI Charges</h4>
          <p>
            Charged at ₹10 per crore + GST by Securities and Exchange Board of
            India for regulating the markets.
          </p>
          <h4 className="mb-4">DP (Depository participant) charges</h4>
          <p>
          ...
          <h4 className="mb-4">Pledging charges</h4>
          <p>₹30 + GST per pledge request per ISIN.</p>
          <h4 className="mb-4">AMC (Account maintenance charges)</h4>
          <p>
          ...
          <h4 className="mb-4">Corporate action order charges</h4>
          <p>
            ₹20 plus GST will be charged for OFS / buyback / takeover /
            delisting orders placed through Console.
          </p>
          <h4 className="mb-4">Off-market transfer charges</h4>
          <p>₹25 per transaction.</p>
          <h4 className="mb-4">Physical CMR request</h4>
          <p>
            First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for
            subsequent requests.
          </p>
          <h4 className="mb-4">Payment gateway charges</h4>
          <p>₹9 + GST (Not levied on transfers done via UPI)</p>
          <h4 className="mb-4">Delayed Payment Charges</h4>
          <p>
        ...
        <h3 className="mb-4 mt-5">Disclaimer</h3>
